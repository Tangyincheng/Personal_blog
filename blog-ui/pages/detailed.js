...
const Detailed = (props) => {
  ...
  useEffect(() => {
    ...
    if (!count) {
      ...
      document.cookie = `count-${props.id}=${props.id};expires=${exp.toGMTString()}`;
    } else if (count) {
            ...
            <Spin tip="加载中..." spinning={loading}>
              ...
              <div>
                ...
                <div className="list-icon center">
                  <span><CalendarOutlined />上次更新时间：{props.addTime.split(' ')[0]}</span>
                  <span><FolderOpenOutlined /> 文章分类：{props.typeName}</span>
                  <span><FireOutlined /> 阅读人数：{props.view_count}人</span>
                </div>
